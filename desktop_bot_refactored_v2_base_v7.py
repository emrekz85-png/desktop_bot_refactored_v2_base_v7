...
class TradingEngine:
    ...
    def check_signal_diagnostic(
        ...
        dokunuşları bu yön filtresiyle tetikleyici olur. Fonksiyon; canlı tarama,
        backtest ve optimizasyon akışında ortak kullanıldığı için PBEMA yön
        kuralı tüm modlarda aynıdır.
        """
